...
# workaround for dvpg
Get-Vm -Id (Get-NsxEdge -Name $edgeName).appliances.appliance.vcUuid | Get-NetworkAdapter |
    where NetworkName -eq $network.Name | Set-NetworkAdapter -NetworkName "VM_Network"
